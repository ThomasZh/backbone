...
var tmp_paragraph_id;

function showActionSheet(paragraph_id) {
  tmp_paragraph_id = paragraph_id;
  ...
  $('#actionsheet_down').one('click', function () {
    var c = $("#"+paragraph_id);
    var n = c.next();
    c.insertAfter(n);
    hideActionSheet(weuiActionsheet, mask);
  ...
  $('#actionsheet_edit').one('click', function () {
    location.href = "/blog/paragraphs/" + paragraph_id + "/edit";
  });
...
function comfirmYes() {
  var p = $("#"+tmp_paragraph_id).children();
  p.remove();
