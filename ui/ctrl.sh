...
#        ./crntb-adm.sh uninstall
        echo "Stopping ui.7x24hs.com service, begin killing ${PID}"
    ...
    if [ "$PID" != "" ] ; then
        echo "Starting ui.7x24hs.com service..."
        nohup python index.py -log_file_prefix=./log/ui.log &
        echo $! > pidfile    #record process id to file
        echo 'Startup ui.7x24hs.com service success!'
