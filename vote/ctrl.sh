...
#        ./crntb-adm.sh uninstall
        echo "Stopping vote.7x24hs.com service, begin killing ${PID}"
    ...
    if [ "$PID" != "" ] ; then
        echo "Starting vote.7x24hs.com service..."
        nohup python index.py -log_file_prefix=./log/vote.7x24hs.com.log &
        echo $! > pidfile    #record process id to file
        echo 'Startup vote.7x24hs.com service success!'
