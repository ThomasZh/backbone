...
#        ./crntb-adm.sh uninstall
        echo "Stopping 7x24hs.com service, begin killing ${PID}"
    ...
    if [ "$PID" != "" ] ; then
        echo "Starting 7x24hs.com service..."
        nohup python index.py -log_file_prefix=./log/7x24hs.com.log &
        echo $! > pidfile    #record process id to file
        echo 'Startup 7x24hs.com service success!'
